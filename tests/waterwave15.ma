...
[waterwave]
type : cell
dim : (17,17,10) % HalfStepFlag H U V Hx Ux Vx Hy Uy Vy
border : wrapped
delay : transport
...
initialValue : 0
initialCellsValue : waterwave15.val
localTransition : none
zone : HalfStep { (1,1,9)..(15,15,9) }
zone : Hx { (0,0,8)..(15,14,8) }
zone : Ux { (0,0,7)..(15,14,7) }
zone : Vx { (0,0,6)..(15,14,6) }
zone : Hy { (0,0,5)..(14,15,5) }
zone : Uy { (0,0,4)..(14,15,4) }
zone : Vy { (0,0,3)..(14,15,3) }
zone : H { (1,1,2)..(15,15,2) }
zone : U { (1,1,1)..(15,15,1) }
zone : V { (1,1,0)..(15,15,0) }
