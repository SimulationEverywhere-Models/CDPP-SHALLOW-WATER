...
[waterwave]
type : cell
dim : (12,12,10) % HalfStepFlag H U V Hx Ux Vx Hy Uy Vy
border : wrapped
delay : transport
...
initialValue : 0
initialCellsValue : waterwave10.val
localTransition : none
zone : HalfStep { (1,1,9)..(10,10,9) }
zone : Hx { (0,0,8)..(10,9,8) }
zone : Ux { (0,0,7)..(10,9,7) }
zone : Vx { (0,0,6)..(10,9,6) }
zone : Hy { (0,0,5)..(9,10,5) }
zone : Uy { (0,0,4)..(9,10,4) }
zone : Vy { (0,0,3)..(9,10,3) }
zone : H { (1,1,2)..(10,10,2) }
zone : U { (1,1,1)..(10,10,1) }
zone : V { (1,1,0)..(10,10,0) }
